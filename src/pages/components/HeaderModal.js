...
const HeaderModal = ({profile, setProfile}) => {
	...
	const setData = () => {
		if(check === false && check !== null) {
			getBody.addEventListener("click",() => setProfile(false))
		}
	}
								...
								<>
									{
										showData ?
											<div className="d-flex heart-item">
												<button onClick={() => checkData()} className="p-0 m-0 h-goto-page d-flex w-100 justify-content-between align-items-center">
