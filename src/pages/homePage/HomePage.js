				...
				<div className="container">
					<div className="row px-5" style={{marginTop: 100}}>
						<div className="col-12 col-md-8">
							...
							other greater pleasures, or else he endures pains to avoid worse pains."The standard Lorem Ipsum passage,
						...
						<div className="hp-r-side col-12 col-md-4 position-sticky d-md-none d-lg-block">
